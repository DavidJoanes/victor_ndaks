  ...
  Widget build(BuildContext context) {
    return const Column(
      ...
      children: [
        ...
        AnimatedLinearProgressIndicator(percentage: 0.75, title: 'JavaScript',image: 'assets/icons/java-script.png'),
        AnimatedLinearProgressIndicator(percentage: 0.8, title: 'Python',image: 'assets/icons/python.png'),
        AnimatedLinearProgressIndicator(percentage: 0.7, title: 'React',image: 'assets/icons/react.png'),
        AnimatedLinearProgressIndicator(percentage: 0.8, title: 'NodeJS',image: 'assets/icons/nodejs.png'),
        AnimatedLinearProgressIndicator(percentage: 0.6, title: 'AWS',image: 'assets/icons/aws.png'),
      ],);
  }
}
